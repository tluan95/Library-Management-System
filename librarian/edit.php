            ...
            <div class="">
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
							...
							<input type ="text" name="t1" class="form-control" placeholder="Enter Items Title">
							<input type ="submit" name="submit1" value="search items" class="btn btn-default">
							</form>
							...
							echo "<td>";?><a href = "edit_items.php?id=<?php echo $row["id"];?>">Edit Items</a><?php echo"</td>";
							echo"</tr>";
							}	
							echo"</table>";
							}
